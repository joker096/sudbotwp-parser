...
- **Объём:** 2500+ слов, живой экспертный тон, без канцелярита
- **Структура:** h2-h4, p, ul, ol, li, strong, em, details, summary, section
- **Таблицы:** 2+ таблицы (table/thead/tbody/tr/th/td) с полезными сравнениями
...
- **CTA-блоки:** Вставляй по смыслу в естественных местах статьи (не более 3-4 на статью):
...
- **excerpt:** 1-2 предложения, краткое описание статьи
- **read_time:** Рассчитай исходя из 150 слов/мин
- **Запрещено:**
