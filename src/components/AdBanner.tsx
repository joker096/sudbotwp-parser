...
function AdBanner({ 
  ...
  const bannerContent = (
    <div className="w-full bg-slate-100 dark:bg-slate-800/50 rounded-[2rem] p-6 flex flex-col sm:flex-row items-center gap-6 border border-slate-200 dark:border-slate-700 relative overflow-hidden group cursor-pointer transition-all">
      ...
      <div className="flex-1 text-center sm:text-left mt-2 sm:mt-0">
        <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-2 group-hover:text-accent transition-all">
          {displayText}
        </h3>
        <p className="text-sm text-slate-500 dark:text-slate-400 mb-4 line-clamp-2">
          {displayDesc}
        </p>
        <span className="inline-flex items-center gap-1.5 text-sm font-bold text-accent hover:text-accent-light transition-all">
