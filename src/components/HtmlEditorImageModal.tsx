    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white dark:bg-slate-900 rounded-2xl shadow-2xl w-full max-w-md mx-4">
        ...
        <div className="p-6 space-y-4">
          <div>
            <label className="text-sm font-medium text-slate-700 dark:text-slate-300 mb-2 block">URL изображения</label>
            <input
              type="url"
              value={imageUrl}
          ...
          {imageUrl && imageUrl.startsWith('http') && (
            <div className="rounded-lg overflow-hidden bg-slate-100 dark:bg-slate-700 h-40">
