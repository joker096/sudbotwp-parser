...
export default function MentionInput({ 
  ...
  return (
    <div className="relative">
      <div className="flex items-center gap-2 bg-slate-50 dark:bg-slate-800 p-2 rounded-2xl border border-slate-200 dark:border-slate-700 focus-within:border-accent dark:focus-within:border-accent transition-all">
        <textarea
          ref={inputRef}
          value={value}
        ...
        {value.trim() && onSend && (
          <button 
            onClick={onSend}
            className="p-3 rounded-xl transition-all flex items-center justify-center bg-accent text-white shadow-md hover:bg-accent-light"
          >
