...
const faqSections = [
  ...
  },
  {
    ...
    items: [
      {
        q: 'Как добавить свои документы?',
        a: '1. Перейдите в раздел "Документы"\n2. Вкладка "Мои документы" — загрузите свои файлы\n3. Перетащите файл или нажмите "Выбрать файлы"\n4. Поддерживаются PDF, Word, Excel, изображения (до 10 МБ)\n5. Загруженные документы доступны только вам'
      },
      {
        q: 'Какие шаблоны документов доступны?',
        a: 'В разделе "Документы" -> вкладка "Шаблоны" доступны:\n- Исковое заявление\n- Возражения на иск\n- Ходатайство\n- Апелляционная жалоба\n- Кассационная жалоба\n- Досудебная претензия\n- Расписка\n- Доверенность'
      },
      {
        q: 'Где найти образцы исковых заявлений?',
        a: 'Образцы исковых заявлений и других юридических документов доступны:\n1. В разделе "Документы" -> "Шаблоны" — готовые шаблоны\n2. ИИ-Юрист может составить иск по вашей ситуации\n3. На специализированных ресурсах (gppart66.ru и др.) — для ознакомления с форматами'
      },
      {
        q: 'Как ИИ-Юрист помогает с документами?',
        a: 'ИИ-Юрист может:\n- Составить исковое заявление по вашей ситуации\n- Подготовить возражения на иск\n- Составить ходатайство\n- Собрать перечень необходимых документов\n- Дать правовую консультацию по документу'
      }
    ]
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'При оформлении подписки (Базовый или Премиум) вы получаете неограниченное количество сообщений ИИ-Юристу.'
      },
      {
        q: 'Что может ИИ-Юрист?',
        a: 'ИИ-Юрист помогает:\n- Составлять иски, возражения, жалобы\n- Анализировать правовые ситуации\n- Готовить списки документов\n- Разъяснять законы РФ\n- Оценивать перспективы дела в суде'
      },
      {
        q: 'Как оформить подписку для ИИ-Юриста?',
        a: '1. Перейдите в профиль\n2. Выберите тариф (Базовый или Премиум)\n3. Оплатите — и получайте неограниченный доступ к ИИ-Юристу'
      }
    ]
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'Зависит от тарифа мониторинга:\n- Базовый: до 5 ИНН\n- Бизнес: до 20 ИНН\n- Премиум: до 100 ИНН'
      },
      {
        q: 'Какие тарифы мониторинга?',
        a: 'Тарифы мониторинга контрагентов:\n\nБазовый — 2 900 ₽/мес\n- 5 ИНН\n- Проверка каждые 24ч\n- Email-уведомления\n- Базовая аналитика\n\nБизнес — 9 900 ₽/мес\n- 20 ИНН\n- Проверка каждые 6ч\n- Telegram уведомления\n- Расширенная аналитика\n- История 2 года\n\nПремиум — 29 000 ₽/мес\n- 100 ИНН\n- Проверка каждый час\n- Приоритетная поддержка\n- Полная аналитика\n- API доступ\n- Персональный менеджер'
      },
      {
